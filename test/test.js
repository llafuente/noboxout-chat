...
test("create server", function (t) {
    ...
    t.equal(mgr.get_server(1) !== null, true, "server(1) is not null");
...
test("user2 join room 1:1 ", function (t) {
    console.log("\n\n");
    var end_wrap = (function() { console.log("xxx"); t.end(); }).after(5);
    ...
    user1.on("relay_message", test_messages, false, 2);
...
test("user1 leave room 1:1 ", function (t) {
    console.log("\n\n");
    var end_wrap = (function() { console.log("xxx"); t.end(); }).after(3);
...
test("user2 leave room 1:1 ", function (t) {
    console.log("\n\n");
    var end_wrap = (function() { console.log("xxx"); t.end(); }).after(1);
